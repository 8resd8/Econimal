...
public class Prompt {
	...
	public static String GlobeFeedbackPrompt(UserLogDto userLogDto) {
		...
		return """
			...
			- 피드백은 약 500자 분량으로 간결하고 이해하기 쉽게 구어체로 작성해주세요.
			
			# 평가 결과:
			- feedback: (약 500자 내외의 피드백)
			- carbon: (숫자로만, 예상되는 내가 100만명 있을 때 평균에 비해 변화한 탄소량, 음수의 경우 탄소의 감소를 의미)
			- temperature: (숫자로만, carbon을 바탕으로 예상되는 변화하는 온도량, 음수의 경우 평균 온도의 감소를 의미)
