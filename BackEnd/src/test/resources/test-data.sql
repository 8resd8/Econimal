...
-- 1. 제품(Product) 데이터
INSERT INTO product (product_id, product_type, price) VALUES (1, 'CHARACTER', 0);
INSERT INTO product (product_id, product_type, price) VALUES (2, 'CHARACTER', 0);
INSERT INTO product (product_id, product_type, price) VALUES (3, 'CHARACTER', 0);
INSERT INTO product (product_id, product_type, price) VALUES (4, 'CHARACTER', 500); # 신규 캐릭터
select p.product_id from product p;
# -- 1-1. 캐릭터(Character) 데이터
# 2, 3번은 삽입됨. 그런데 1, 4는 안돼. product Unique문제? -> 아니었음.
INSERT INTO characters (character_id, product_id, character_name, character_type, summary, description, exp_per_level, max_level, is_original) VALUES
    (1, 1, '부기부기', 'OCEAN', '바다에 사는 바다 거북이에요', '안녕, 나는 바다의 쓰레기를 줄여야 한다고 생각해. 여러분 도와주세요!. 바다의 플라스틱 쓰레기 때문에 바다 거북이들이 위험해지고 있어요. 여러분이 저희를 함께 도와주면 바다의 깨끗한 환경을 만들 수 있을 거예요', 1000, 1, 3);
INSERT INTO characters (character_id, product_id, character_name, character_type, summary, description, exp_per_level, max_level, is_original) VALUES
    (2, 2, '팽글링스', 'POLAR', '남극에 사는 펭귄이에요', '안녕, 나는 수영보다 걷기를 좋아하는 펭귄이야. 여러분 도와주세요!. 남극의 펭귄 친구들은 빙하가 녹아 힘들어하고 있어요. 여러분이 저희를 함께 도와주면 펭귄들이 행복하게 살 수 있는 환경을 만들 수 있을 거예요', 1000, 1, 3);
INSERT INTO characters (character_id, product_id, character_name, character_type, summary, description, exp_per_level, max_level, is_original) VALUES
    (3, 3, '호랭이', 'FOREST', '산 속에 사는 호랑이에요', '안녕, 나는 숲의 보존이 중요하다고 생각해. 여러분 도와주세요!. 산림 파괴로 인해 호랑이의 서식지가 줄어들고 있어요. 여러분이 저희를 함께 도와주면 호랑이들이 안전하게 살 수 있는 숲을 지킬 수 있을 거예요',1000, 1, 3);

# 신규 캐릭터
INSERT INTO characters (character_id, product_id, character_name, character_type, summary, description, exp_per_level, max_level, is_original) VALUES
    (4, 4, '언젠가추가될신규캐릭터', 'FOREST', '신규요약', '신규 설명',1000, 0, 3);
