...
INSERT INTO characters (character_id, product_id, character_name, character_type, summary, description, exp_per_level,
                        max_level, is_original)
VALUES (1, 1, '부기부기', 'OCEAN', '바다에 사는 바다 거북이에요', '안녕', 1000, 3, FALSE),
       (2, 2, '팽글링스', 'POLAR', '남극에 사는 펭귄이에요', '안녕', 1000, 3, FALSE),
       (3, 3, '호랭이', 'FOREST', '산 속에 사는 호랑이에요',
        '안녕, 나는 숲의 보존이 중요하다고 생각해. 여러분 도와주세요! 산림 파괴로 인해 호랑이의 서식지가 줄어들고 있어요. 함께 도와주면 호랑이들이 안전하게 살 수 있는 숲을 지킬 수 있을 거예요',
        1000, 3, FALSE),
...
VALUES (1, '사용하지 않는 방의 전등 끄기', 'LOW', 'ELECTRICITY', 10),
...
-- [WATER]
INSERT INTO checklist (checklist_id, description, difficulty, eco_type, exp)
VALUES (6, '양치컵 사용 및 물 받아쓰기', 'LOW', 'WATER', 10),
...
-- [GAS]
INSERT INTO checklist (checklist_id, description, difficulty, eco_type, exp)
VALUES (11, '겨울철 내복 입고 실내 온도 20℃ 유지하기', 'LOW', 'GAS', 10),
...
-- [COURT]
INSERT INTO checklist (checklist_id, description, difficulty, eco_type, exp)
VALUES (16, '전자 소송 적극 활용 및 종이 사용 줄이기', 'MEDIUM', 'COURT', 10),
...
-- 유저 배경 데이터
INSERT INTO user_background (user_id, product_id, is_main)
VALUES (1, 5, true);